...
descrTable(formu,data=dadesDM%>%filter(EV.TBC_cat=="No"),show.p.overall = T,show.n = T,method = 1,Q1=0,Q3=1,show.all = TRUE) %>%
  export2md(caption = "Tabla  2c. Características NO TBC según grado de control de la DM <7.5% us >=7.5% [Medias,Sd]")
...
# MODEL4::
if (params$metode=="dinamica2") res.cox<-coxph(surv_tbc ~ sexe+age+DM_anys+MACRO+DG.TAB_cat+DG.ALCOHOL_cat+IMC.valor+HBA1c.valor, data=dadesDM) 
