...
kkk<-dt_agencia %>% select(CIP,TB__PULMONAR,TB_PLEURAL,TB_PLEUROPULM,TB_LIMFATICA,TB_OSTEOART,TB_MILIAR,TB_GENITOURIN,TB_MENINGEA,TB_LARINGEA,TB_ALTRESLOC,PPD,RADIOLOGIA,PPD)
...
```{r JOPSEP: Baseline characteristics of the study variables between diabetics with and withou TB,include=T}
