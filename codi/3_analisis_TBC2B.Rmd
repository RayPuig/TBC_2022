...
descrTable(formu,data=dadesDM,show.p.overall = T,show.n = T,method = 1,Q1=0,Q3=1) %>%
  export2md(caption = "Tabla  2b. Características basales de las variables de estudio entre diabéticos con y sin TBC [Medias,Sd]")

descrTable(formu,data=dadesDM,show.p.overall = T,show.n = T,method = 2,Q1=0,Q3=1) %>%
...
descrTable(formu,data=dadesDM%>%filter(EV.TBC_cat=="Si"),show.p.overall = T,show.n = T,method = 1,Q1=0,Q3=1) %>%
...
res1b %>% bind_rows(res5)  %>%
  kable(digits = 2,caption = "Table 3b. Incidence of TBc with DM patients  for HbA1c>=7.5%  ") %>% kableExtra::kable_styling()
...
```{r genero_HR, message=FALSE, warning=FALSE, include=T, echo=FALSE,size="huge",eval = F}
