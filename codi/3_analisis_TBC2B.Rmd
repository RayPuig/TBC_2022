...
dadesDM<-dadesDM%>%mutate(TIP_TBC=case_when(  
                          (TB__PULMONAR=="Si" |TB_PLEURAL=="Si" | TB_PLEUROPULM=="Si"| TB_MILIAR=="Si") ~ "TBC PUlmonar",
                          (TB_LIMFATICA=="Si" |TB_OSTEOART=="Si" | TB_GENITOURIN=="Si"| TB_MENINGEA=="Si"| TB_LARINGEA=="Si" | TB_ALTRESLOC=="Si") ~ "TBC Extra.Plmonar"))
...
# Ajustos
vector_ajustos<-c("ajuste01","ajuste02","ajuste03") %>%stats::setNames(c("Modelo sin ajustar","Modelo 1-HbA1c_8","Modelo 2-HbA1c_8"))  
# Models de COX 
...
# Ajustos
vector_ajustos<-c("ajuste1","ajuste2","ajuste3","ajuste4","ajuste5","ajuste6","ajuste7") %>%stats::setNames(c("Modelo 1-HbA1c_7.5","Modelo 2-HbA1c_7.5","Modelo 3-HbA1c_7.5","Modelo 4-HbA1c_7.5","Modelo 5-HbA1c_7.5","Modelo 6-HbA1c_7.5","Modelo 7-HbA1c_7.5"))  
# Models de COX 
taula_models_COX<-vector_ajustos %>% purrr::map_df(~extreure_HR(a="HbA1c_7.5",x=.x,event = "event_tbc",t="temps_tbc",d=dadesDM,taulavariables = conductor_variables,c=""),.id="Model")
taula_models_COX%>% 
  kable(digits = 3,caption = "Analisis Multivariante de los factors con pacientes DM  que pueden  influir a la TBC") %>% 
...
# Ajustos
vector_ajustos<-c("ajuste04","ajuste05") %>%stats::setNames(c("Modelo 1-HbA1c_9","Modelo 2-HbA1c_9"))  
# Models de COX 
...
# Ajustos
vector_ajustos<-c("ajuste8","ajuste9","ajuste10","ajuste11","ajuste12","ajuste13","ajuste14") %>%stats::setNames(c("Modelo 1-HbA1c_9","Modelo 2-HbA1c_9","Modelo 3-HbA1c_9","Modelo 4-HbA1c_9","Modelo 5-HbA1c_9","Modelo 6-HbA1c_9","Modelo 7-HbA1c_9"))  
# Models de COX 
taula_models_COX<-vector_ajustos %>% purrr::map_df(~extreure_HR(a="HbA1c_9",x=.x,event = "event_tbc",t="temps_tbc",d=dadesDM,taulavariables = conductor_variables,c=""),.id="Model")
taula_models_COX%>% 
  kable(digits = 3,caption = "Analisis Multivariante de los factors con pacientes DM  que pueden  influir a la TBC") %>% 
