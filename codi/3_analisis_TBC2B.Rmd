...
# TABLA 1.TABLA2:  Características basales de los pacientes en cohorte diabetica
...
# Tabla.4b Modelos.Análisis multivariante de los factores que pueden influir en la aparición de una nueva TBC, en una Población Diabetica
...
res.cox %>% sjPlot::tab_model(show.p = TRUE,title = "Modelo 7")
...
res.cox %>% sjPlot::tab_model(show.p = TRUE,title = "Modelo 8")
...
res.cox %>% sjPlot::tab_model(show.p = TRUE,title = "Modelo 9")
...
# 5. Modelos de Cox dependientes del Tiempo (HBA1c) para la TBC
...
## Tabla.5a Modelos de Cox dependientes del Tiempo (HBA1c) para la TBC.[Hba1c>7.5+Sexe+Edat+cluster(idp]
...
## Tabla.5b Modelos de Cox dependientes del Tiempo (HBA1c) para la TBC.[Hba1c>8+Sexe+Edat+cluster(idp]
...
## Tabla.5c Modelos de Cox dependientes del Tiempo (HBA1c) para la TBC.[Hba1c>9+Sexe+Edat+cluster(idp]
